...
export default function LeavesPage() {
  ...
  const canApproveManager = hasPermission(role ?? undefined, 'leaves.approve_manager');
  const canApproveHr = hasPermission(role ?? undefined, 'leaves.approve_hr');
  ...
  async function handleSubmit() {
    ...
    const { error } = await supabase.from('leaves').insert({
      employee_id: form.employee_id, type: form.type, start_date: form.start_date, end_date: form.end_date, days, reason: form.reason, status: 'pending',
    });
